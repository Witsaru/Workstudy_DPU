...
while cap1.isOpened():
    ...
    if deter and not paused:
        ...
        if mode == 1:
            ...
            holistic.show_action(image2, draw=False)
        ...
        if len(list_pose) > 0:
            ...
            if mode == 1 :
                ...
                print(f"Step1: {time_2['Step1']}")
                print(f"Step2: {time_2['Step2']}")
                print(f"Step3: {time_2['Step3']}")
                print(f"Step4: {time_2['Step4']}")
                print(f"Step5: {time_2['Step5']}")
                print(f"Step6: {time_2['Step6']}")
                print(f"Step7: {time_2['Step7']}")
                print()
